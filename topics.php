					...
					<div class="card-body">
						<ul class="w-100 list-group" id="topic-list">
							...
							<li class="list-group-item mb-4">
								...
								<p class="row justify-content-left"><span class="badge badge-success text-white"><i>Đăng bởi: <?php echo $row['name'] ?></i></span></p>
								<hr>
								
								<span class="float-left badge badge-secondary text-white"><?php echo number_format($view) ?> view/s</span>
								<span class="float-left badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format($view) ?> Bình luận <?php echo $replies > 0 ? " and ".number_format($replies).' replies':'' ?> </span>
