...
<ul id="clone-ul" style="display: none">
	<li class="list-group-item mb-4">
		<div>
            <span class="float-right mr-4"><small><i>Tạo bởi: <span class="created"></span></i></small></span>
			<a href="" class=" filter-text title"><?php echo $row['title'] ?></a>

		</div>
		<hr>
		<p class="truncate filter-text desc"></p>
		<p class="row justify-content-left"><span class="badge badge-success text-white"><i>Đăng bởi: <span class="posted"></span></i></span></p>
		<hr>
		<div class="row">
			<div class="col-lg-12">
